...
def hasil(request):
    ...
    if(valid == False):
        ...
        valid = True
    return render_to_response('products/answer16.html',{'grid_orig16':json.dumps(grid_orig16),'grid16':json.dumps(grid16),'out16':out16,'add':add,'jumSol':json.dumps(jumSol)})